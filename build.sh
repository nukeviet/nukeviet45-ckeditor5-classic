...
PLUGINS=("ckeditor5-nvbox" "ckeditor5-nvmedia" "ckeditor5-nviframe" "ckeditor5-nvdocs" "ckeditor5-nvtools")
PLUGINS_TO_COPY=("nvbox" "nvmedia" "nviframe" "nvdocs" "nvtools")

if [[ -n "$1" ]]; then
  arg="$1"
  PLUGINS=("ckeditor5-$arg")
  PLUGINS_TO_COPY=("$arg")
fi
